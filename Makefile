...
builtin/exit.c  signal/signals.c exec/ft_open_file.c exec/ft_fonction_exec.c ft_s_printf/ft_s_base_printf.c ft_s_printf/ft_s_printf.c ft_s_printf/ft_s_printf_str.c ft_s_printf/ft_s_ptr_printf.c )
